...
public class Cuenta 
{
	...
	public Cuenta (int numCuenta , String clave , double saldo , String tipoCuenta) 
	{
	...
	public String toString() {
		...
		return " Numero de Cuenta: " + numCuenta + " con clave de acceso : "+clave+" posee un saldo de: "+saldo+ " siendo de tipo: "+tipoCuenta;
	}
