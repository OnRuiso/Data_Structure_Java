			...
			while(true)
			{
				try {
					teclado = Integer.parseInt(JOptionPane.showInputDialog("Bienvenido, seleccione una opcion \n\n"
							...
							+ "[6] Buscar Vehiculos segun el Modelo [revisar]\n"
							+ "[7] Mostrar Vehiculos ordenados por Modelo [revisar solo Particular]\n"
							+ "[8] Mostrar Vehiculos ordenados por Precio [revisar solo Particular]\n\n"
