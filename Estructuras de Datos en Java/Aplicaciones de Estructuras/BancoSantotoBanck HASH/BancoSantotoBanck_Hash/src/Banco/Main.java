		...
		while(estado)
		{
			...
			while(true)
			{
				try {
					teclado = Integer.parseInt(JOptionPane.showInputDialog("Seleccione una opcion \n"
							...
							+ "[3] Ver detalles de una cuenta especifica \n"
							+ "[4] Eliminar un cliente especificamente"
			...
			switch(teclado)
			{
				...
				case 2:
					...
					break;
				case 3:
					main.santoto.especificaCuenta();
					break;
				case 4:
					main.santoto.especDeleteCuenta();
					break;
