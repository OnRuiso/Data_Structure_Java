...
public class Panaderia
{
    ...
    {			
      ...
      //********************************************************************************************** VERSION 2
    	...
    	String [] comDia = new String[300];//almacenar cada venta por separado para la discriminacion
    	for(int i = 0;i<300;i++)
            comDia[i] = "";
    	//**********************************************************************************************
        	...
        	switch(teclado)
        	{
      		 ...
      		 // .....................................................................................................................................................................
        		...
        		case 13://Imprimir Recibo de Compra
    	            ...
    	            comDia[v1] = cliente.getNombre() + ":  " + totalCompra; 
    	            //********************************************************************************
        			
        			String nombreRecibo = "ReciboPanaderia"+cliente.getNombre();
        			
        			try {
        	            PrintWriter writer = new PrintWriter("D:/ruiso/ESTUDIOS/Ingenieria de Sistemas/MATERIAS/SEMESTRE I/Estructuras de Datos/Eclipse Folder/Quiz Panaderia V2/src/"+nombreRecibo+".txt", "UTF-8");
        		...
        		case 15:
        			...
        			try
        			{
        				PrintWriter writer = new PrintWriter("D:/ruiso/ESTUDIOS/Ingenieria de Sistemas/MATERIAS/SEMESTRE I/Estructuras de Datos/Eclipse Folder/Quiz Panaderia V2/src/Producido del DIA.txt", "UTF-8");
            			...
            			for (int i = 0 ; i < comDia.length ; i++)
            			{
            				//JOptionPane.showMessageDialog(null, comDia[i]);
            				writer.println( comDia[i] );
