...
public class Inicio 
{
   ...
   private Panaderia tienda;
    ...
    public static void main(String[] args)
    {
    	...
    	//-----------------------------------------------------------------------------Formas de inicializacion del vector Pannaderia -- total de las ventas
    	
    	//[1] Inicializar vector directamente en la clase Panaderia
    	/*
    	...
    	*/
    	...
    	//[2]  Inicializar vector de clase Panaderia utilizando un vector local temporal
    	/*
    	...
    	*/
    	...
    	//[3] llamar metodo de la clase Panaderia para su ejecucion
    	
    	m.tienda.inicializarTotal(); //llama el metodo para inicializar el vector en panaderia correspondiente a los totales
    	
    	
    	
    	
    	//[4] Cambiar posiciones especificas del vector de la clase Panaderia
    	/*
    	...
    	// Formas de impresion del vector de la clase Panaderia
    	/*
