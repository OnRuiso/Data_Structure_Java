...
public class Panaderia
{
    ...
    private String totalVentas[]; // ***** VERSION 3

    public Panaderia()
    {
    	this.totalVentas = new String[100];    
    }
	...
	public void setTotalVentas(String[] totalVentas) {		this.totalVentas = totalVentas;	}
    // ******
    ...
    {			
        ...
        JOptionPane.showMessageDialog(null," - VERSION 3 -"
        		+"\n QUIZ PRACTICO  "
      ...
      //********************************************************************************************** VERSION 2
    	int buyDay = 0;//sumar todas las ventas del dia
    	
    	String [] comDia = new String[100];//almacenar cada venta por separado para la discriminacion
        ...
        while(estado)//new
        {
        	...
        	while(true)
        	{
        		try
        		{
            		...
            		+"\n  \n [15] IMPRIMIR RECIBO VENTAS DEL DIA "
            		+"\n "));//new
        	...
        	switch(teclado)
        	{
      		 ...
      		 // .....................................................................................................................................................................
        		...
        		case 13://Imprimir Recibo de Compra
        			 ...
        			 //******************************************************************************** VERSION 2
    	            buyDay = buyDay + totalCompra; //suma la venta al total del dia
    	            int v1 =+ 1;//cuenta uno cada que se imprime el recibo , cada que se finaliza la venta , a la vez es el numero de ventas en el dia
    	            
    	            //comDia[v1] = cliente.getNombre() + ":  " + totalCompra;  //deshabilitado para version 3
    	            //********************************************************************************
    	            getTotalVentas()[v1]= cliente.getNombre() + ":  " + totalCompra; //VERSION 3
        			
        			String nombreRecibo = "ReciboPanaderia"+cliente.getNombre();
        			
        			try {
        	            PrintWriter writer = new PrintWriter("D:/ruiso/ESTUDIOS/Ingenieria de Sistemas/MATERIAS/SEMESTRE I/Estructuras de Datos/Eclipse Folder/Quiz Panaderia V3/src/"+nombreRecibo+".txt", "UTF-8");
        		...
        		case 15:
        			...
        			try
        			{
        				PrintWriter writer = new PrintWriter("D:/ruiso/ESTUDIOS/Ingenieria de Sistemas/MATERIAS/SEMESTRE I/Estructuras de Datos/Eclipse Folder/Quiz Panaderia V3/src/Producido del DIA.txt", "UTF-8");
            			
            			writer.println("______________________________________________________");
            			
            			JOptionPane.showMessageDialog(null, "La ventas totales del dia son: "+buyDay);
            			writer.println("La ventas totales del dia son: "+buyDay);
            			writer.println("______________________________________________________");
            			
            			for (int i = 0 ; i < getTotalVentas().length ; i++)
            			{
            				writer.println(i+").  "+ getTotalVentas()[i] );
            			}
	...
	//[3.1] Inicializar vector localmente por metodo 
